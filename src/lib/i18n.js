...
const STRINGS = {
  ...
  "deck.addpage": ["+ Página", "+ Page", "+ 页面"],
  "deck.more": ["Más opciones", "More options", "更多选项"],
  "deck.exportshort": ["Exportar respaldo", "Export backup", "导出备份"],
  "deck.importshort": ["Importar respaldo", "Import backup", "导入备份"],
  "deck.reset": ["Simplificar tablero", "Simplify deck", "简化面板"],
  "deck.resetconfirm": [
    "Se reemplazarán las páginas y botones de este tablero por la versión simple. Podrás deshacerlo antes de guardar.",
    "This deck's pages and buttons will be replaced by the simple version. You can undo it before saving.",
    "此面板的页面和按钮将替换为简化版本。保存前可以撤销。",
  ],
  ...
  "settings.title": ["Configuración", "Settings", "设置"],
  "settings.advanced": ["Funciones avanzadas", "Advanced features", "高级功能"],
  "manual.feature": ["Modo Manual", "Manual mode", "手动模式"],
  "manual.featurehint": [
    "Muestra tableros fijos que configuras en este PC.",
    "Shows fixed decks that you configure on this PC.",
    "显示你在这台电脑上配置的固定面板。",
  ],
  "manual.introtitle": ["Modo Manual activado", "Manual mode enabled", "手动模式已启用"],
  "manual.introbody": [
    ...
    "即使你在电脑上切换应用，手动模式也会保持固定面板。",
  ],
  "manual.intro1": ["Abre KiBoard en el PC.", "Open KiBoard on the PC.", "在电脑上打开 KiBoard。"],
  "manual.intro2": [
  ...
  "manual.introcta": ["Crear mi primer tablero", "Create my first deck", "创建我的第一个面板"],
  ...
  "catalogue.add": ["Añadir botón", "Add button", "添加按钮"],
  "catalogue.hint": [
    "Haz clic para agregar o arrastra al lugar exacto.",
    "Click to add, or drag to the exact position.",
    "单击添加，或拖到准确位置。",
  ],
  "catalogue.click": [
    "Haz clic para agregarlo o arrástralo al tablero",
    "Click to add it or drag it onto the deck",
    "单击添加或拖到面板上",
  ],
  "cat.frequent": ["Acciones frecuentes", "Frequent actions", "常用操作"],
  "cat.tools": ["Herramientas", "Tools", "工具"],
  "cat.recentapps": ["Aplicaciones recientes", "Recent apps", "最近使用的应用"],
  "auto.waiting": [
  ...
  "device.foreground": ["Aplicación activa", "Active app", "当前应用"],

  // Inspector.svelte
  "insp.title": ["Configurar botón", "Configure button", "配置按钮"],
  "insp.label": ["Etiqueta", "Label", "标签"],
  "insp.appearance": ["Apariencia", "Appearance", "外观"],
  ...
  "insp.defaultcolour": ["Color predeterminado", "Default colour", "默认颜色"],
  "insp.customcolour": ["Elegir otro color", "Choose another colour", "选择其他颜色"],
  "insp.action": ["Acción", "Action", "操作"],
  "insp.action.copy": ["Copiar", "Copy", "复制"],
  "insp.action.paste": ["Pegar", "Paste", "粘贴"],
  "insp.action.cut": ["Cortar", "Cut", "剪切"],
  "insp.action.undo": ["Deshacer", "Undo", "撤销"],
  "insp.action.redo": ["Rehacer", "Redo", "重做"],
  "insp.action.selectall": ["Seleccionar todo", "Select all", "全选"],
  "insp.action.screenshot": ["Tomar una captura", "Take a screenshot", "截屏"],
  "insp.action.trackpad": ["Abrir el trackpad", "Open the trackpad", "打开触控板"],
  "insp.action.dictate": ["Abrir dictado", "Open dictation", "打开听写"],
  "insp.action.record": ["Iniciar o detener grabación", "Start or stop recording", "开始或停止录制"],
  "insp.action.stream": ["Iniciar o detener transmisión", "Start or stop streaming", "开始或停止直播"],
  "insp.action.mic": ["Activar o silenciar micrófono", "Enable or mute microphone", "启用或静音麦克风"],
  "insp.action.launch": ["Abrir o enfocar {0}", "Open or focus {0}", "打开或切换到 {0}"],
  "insp.action.scene": ["Cambiar a la escena {0}", "Switch to scene {0}", "切换到场景 {0}"],
  "insp.action.page": ["Abrir esta página", "Open this page", "打开此页面"],
  "insp.action.advanced": ["Acción personalizada", "Custom action", "自定义操作"],
  "insp.more": ["Más opciones", "More options", "更多选项"],
  "insp.delete": ["Eliminar botón", "Delete button", "删除按钮"],
  ...
  "toast.simplified": ["Tablero simplificado — revisa y guarda", "Deck simplified — review and save", "面板已简化 — 请检查并保存"],
  "toast.pageadded": ["Página {0} creada", "Page {0} created", "已创建第 {0} 页"],
